...
public class ModBlocks {
    public static final OreBlock PLATINUM_ORE = new OreBlock(FabricBlockSettings.of(Material.STONE).strength(100, 2400).requiresTool().sounds(BlockSoundGroup.STONE));
    public static final OreBlock DEEPSLATE_PLATINUM_ORE = new OreBlock(FabricBlockSettings.of(Material.STONE).strength(200, 4800).requiresTool().sounds(BlockSoundGroup.DEEPSLATE));
    public static final Block PLATINUM_BLOCK = new Block(FabricBlockSettings.of(Material.METAL).strength(100, 2400).requiresTool().sounds(BlockSoundGroup.METAL));
    public static final Block RAW_PLATINUM_BLOCK = new Block(FabricBlockSettings.of(Material.METAL).strength(100, 2400).requiresTool().sounds(BlockSoundGroup.METAL));
